class EloRatingSystem {
   ...
   * @param {number} [config.kFactor=32] - K-factor, determines the maximum rating change
   ...
   * @returns {number} Player A's expected score (0 to 1)
   */
   ...
   * @returns {{newRating1: number, newRating2: number, change1: number, change2: number}}
   */
